            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="pageSubmenu">
                        <li>
                            <a href="/employeecreate">Ad Employee</a>
                        </li>
                ...
                {{-- @if(Auth()->user()->roleid==0) --}}
                 ...
                 <thead>
                    <tr>
                     ...
                     <th width="" class="sorting" data-sorting_type="asc" style="cursor: pointer">Roleid </th>
                     ...
                     <th width="" class="sorting" data-sorting_type="asc" style="cursor: pointer">Mobile </th>
                     <th width="" class="sorting" data-sorting_type="asc" style="cursor: pointer">city</th>
                     <th width="" class="sorting" data-sorting_type="asc" style="cursor: pointer">Bdate</th>
                     <th width="" class="sorting" data-sorting_type="asc" style="cursor: pointer">Work start</th>
                     <th width="" class="sorting" data-sorting_type="asc" style="cursor: pointer">Leaves</th>
                     <th width=""></th>
...
<script>
        $(document).ready(function(){
         ...
         {
          $.ajax({
           url:"/dashboard/dashboard/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&query="+query,
